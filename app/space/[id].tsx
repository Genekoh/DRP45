        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View>
              ...
              <Text style={styles.infoValue}>{space.openingHrs}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            ...
            <View>
              ...
              <View style={[styles.crowdnessBadge, { backgroundColor: currentOption.color + "22" }]}>
                <View style={[styles.crowdnessDot, { backgroundColor: currentOption.color }]} />
                <Text style={[styles.crowdnessText, { color: currentOption.color }]}>
                  {currentOption.label}
                </Text>
              </View>
            </View>
